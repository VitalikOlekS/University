        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    else if (roles.FirstOrDefault(r => r == "Teacher") != null)
                    {
                        return RedirectToAction("Dashboard", "TeacherPanel", new { area = "Teacher" });
                    }
                    else if (roles.FirstOrDefault(r => r == "Student") != null)
                    {
                        return RedirectToAction("StudentPanel", "University");
                    }
                    else
                    {
